...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#DDECFF">
  ...
  <tr>
    ...
    <td>当前位置： <a href="../index.jsp" target="_top">首页</a> &gt;&gt; 凭证管理 &gt;&gt; 凭证记账</td>
  </tr>
  <tr>
...
<br />
<s:form action="voucherMng_searchChargeVoucher.action" namespace="/voucherMng" target="down">
  ...
  <tr>
    <td colspan="8" align="left" bgcolor="#E8E8E8"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="200" class="Title">凭证记账</td>
