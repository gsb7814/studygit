...
<body>
	...
	%>
	<s:form action="voucherMng_unChargedVoucher.action"
		...
		<table width="780" border="0" align="center" cellpadding="0"
			...
			<tr>
				...
				<td width="220" align="left" bgcolor="#FAFAFA">
					<div align="center">
						<strong>所在部门</strong>
					</div>
				</td>
				...
				<td width="71" align="left" bgcolor="#FAFAFA">
					<div align="center">
						<input type="checkbox" name="selectAllcheckbox" value="全选/不选" onClick="javascript:selectAll(this,'voucherMngBean.voucherCodeList')"/>
					</div>
				</td>
			</tr>
			...
			<tr>
				<td height="25" colspan="8" align="left" bgcolor="#FFFFFF">
					<div align="right">
						<input name="Submit" type="submit" class="buttonborder"
							value="反记账" />
						&nbsp;
					</div>
				</td>
