...
　　}
   return xmlHttp;
    ...
    function	initView(){
   	 ...
   	 var oDom = oPublicFunction.getDom('<%=contextPath%>/userRole.do?method=createRole');
   ...
   function createMe(){
	 ...
	 if('OK'==returnStr){
	  ...
	  // var oDom = oPublicFunction.getDom('<%=contextPath%>/userRole.do?method=listAllUserRole');
  ...
  <table border="0" width="90%" cellspacing="0" cellpadding="0" align=center> 
    ...
    <tr> 
      <td height="45" colspan="2" bgcolor="#ffffff"><div align="right"><font size="2"></font></div> 
        <input type="button" name="Submit" value=" 创建 " class="White" onclick="createMe();"> 
&nbsp;&nbsp; 
        <input type="reset" name="Submit2" value=" 重置 " class="White"> 
&nbsp;&nbsp; 
