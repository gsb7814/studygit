...
<s:form name="frm" action="dailyLedger.action" method="post">  
 ...
 <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#DDECFF">
  ...
  <tr>
    ...
    <td>当前位置： <a href="../index.htm" target="_top">首页</a> &gt;&gt; 帐薄管理 &gt;&gt; 现金/银行存款日记账</td>
  </tr>
  <tr>
...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999">
  ...
  <tr>
	...
	headerKey="0" headerValue="请选择" value="%{#unitCode.trim()}"></s:select>
        ...
        <td width="71" height="25"><div align="center">
          <s:submit name="export" value="生成"  method="searchDailyLedger"></s:submit>
        </div></td>
      </tr>
    </table></td>
 ...
 %> 
  ...
  <tr>
    ...
    <% 
  PaginationVO lst = (PaginationVO)ActionContext.getContext().get("DailyLedgerSum");
   if (lst != null)
  {
 ...
 <s:url id="url_first" value="dailyLedgerfy.action">
...
<s:set name="tp"><%=totalpage-1%></s:set>
 ...
 <s:if test="CP lt #tp">
     <s:url id="url_next" value="dailyLedgerfy.action">
         <s:param name="CP" value="CP+1"></s:param>
     </s:url> 
</s:if>

     <s:url id="url_last" value="dailyLedgerfy.action">
...
<s:a href="%{url_first}"> 首页 </s:a> <s:a href="%{url_pre}">上一页</s:a> <s:a href="%{url_next}">下一页</s:a>  <s:a href="%{url_last}">尾页</s:a></td>
  ...
  <tr>
    <td height="25" colspan="7" align="left" bgcolor="#FFFFFF" >=<div align="right">
      <s:submit name="export" value="导出"  method="exportDailyLedger"></s:submit></div></td>
  </tr>
</table>
